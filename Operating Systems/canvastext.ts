...
//
const APP_NAME: string    = "JFOS";   // 'cause Bob and I were at a loss for a better name.
const APP_VERSION: string = "12";   // What did you expect?
...
var CONTEXT_SWITCH = 3;  // pick a free value not used by other IRQs
