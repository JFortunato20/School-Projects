...
module TSOS {
    ...
    export class CanvasTextFunctions {
        ...
        public static symbols: { [key: string]: { width: number; points: number[][] } } = {
            ' ': { width: 16, points: [] },
            ...
            '☺': { width: 20, points: [[10,20],[10,0],[-1,-1],[5,15],[5,16],[6,17],[4,17],[5,15],[-1,-1],[15,15],[15,16],[16,17],[14,17],[15,15],[-1,-1],[5,7],[7,5],[10,4],[13,5],[15,7]] }
